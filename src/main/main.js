      ...
      <Content>
        <Sticky>
          <Intro>
            ...
            <Title>
              I create meaningful digital interfaces, that aim to understand the
              people using them.
            </Title>
          </Intro>

          <List>
            <Item>Currently a Product Designer at Stocate & Dynamic CXS.</Item>
            <Item>UR, UX, UI, Digital Marketing, Copywriting.</Item>
            <Item>
              4 + years of experience designing for startups in Ottawa, Toronto
              & Montreal.
            </Item>
          </List>
